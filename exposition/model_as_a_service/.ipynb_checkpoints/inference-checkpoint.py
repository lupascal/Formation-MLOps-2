...
def predict_endpoint():
    Ws1_avg = request.args.get('Ws1_avg')
    Ws2_avg = request.args.get('Ws2_avg')#0.22
    received_data_df = pd.DataFrame(
        {
            ...
            "Yt_max": 20.79, "Yt_std": 0.07, "Ws1_avg": Ws1_avg, "Ws1_min": 0.0, "Ws1_max": 1.94, "Ws1_std": 0.44,
            "Ws2_avg": Ws2_avg, "Ws2_min": 0.0, "Ws2_max": 1.92, "Ws2_std": 0.52, "Ws_avg": 0.18, "Ws_min": 0.0,
